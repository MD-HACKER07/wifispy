...
VERSION = "2.0"
AUTHOR = "MD-HACKER"
AUTHOR_WEBSITE = "https://abushalem.site/"
AUTHOR_GITHUB = "https://github.com/MD-HACKER07"

# Report file paths
DEFAULT_REPORT_DIR = os.path.expanduser("~/wifispy-reports/")
DEFAULT_REPORT_TEMPLATE = "wifispy_report_{}.json"
DEFAULT_CREDS_TEMPLATE = "wifispy_credentials_{}.csv"
...
if not os.path.exists(DEFAULT_REPORT_DIR):
    try:
        ...
        # Fall back to current directory if can't create report dir
        DEFAULT_REPORT_DIR = "./"
