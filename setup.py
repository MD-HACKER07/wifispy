...
try:
    raw_input  # Python 2
    sys.exit("Please use Python 3 to install WifiSpy.")
except NameError:
    pass  # Python 3
...
NAME = "wifispy"
AUTHOR = "MD-HACKER"
AUTHOR_EMAIL = "md@abushalem.site"
URL = "https://github.com/MD-HACKER07/wifispy"
DESCRIPTION = "Modern Wi-Fi Security Assessment Toolkit"
LICENSE = "GPL"
KEYWORDS = ["wifispy", "evil", "twin", "phishing", "wifi", "security", "pentest", "redteam"]
...
ENTRY_POINTS = {"console_scripts": ["wifispy = wifiphisher.pywifiphisher:run"]}
INSTALL_REQUIRES = ["pbkdf2", "scapy>=2.4.5", "tornado>=6.1", "roguehostapd", "pyric"]
DEPENDENCY_LINKS = \
